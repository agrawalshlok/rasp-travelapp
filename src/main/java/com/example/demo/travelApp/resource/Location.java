...
public class Location extends BaseResource {
	...
	public static String FIELD_LOCATION_CODE = "location_code";
	public static String FIELD_STATUS = "status";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("location");
	...
	static {
		...
		location_nameField.setIndexed(true);
		location_nameField.setRequired(true);
		location_nameField.setLength(128);
		metaData.addField(location_nameField);

		Field location_codeField = new Field("location_code", "String");
		location_codeField.setIndexed(true);
		location_codeField.setRequired(true);
		location_codeField.setLength(128);
		metaData.addField(location_codeField);
	...
	public Location() {this.setId(Util.getUniqueId());}
	public Location(String id) {this.setId(id);}
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		location_code = (String) map.get("location_code");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object location_codeObj = map.get("location_code");
		if(location_codeObj != null)
			location_code = location_codeObj.toString();
	...
	public String getLocation_codeEx() {
		return location_code != null ? location_code : "";
	}
	...
	public void unSetLocation_code() {
		this.location_code = null;
	}

	public boolean validateLocation_code(boolean add) throws ApplicationException {
		if(add && location_code == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[location_code]");
		return location_code != null;
	}
	...
	public  Class<?> getResultClass() {return LocationResult.class;};
	public  Class<?> getMessageClass() {return LocationMessage.class;};
	public  Class<?> getHelperClass() {return LocationHelper.class;};
	public  Class<?> getServiceClass() {return LocationService.class;};
}