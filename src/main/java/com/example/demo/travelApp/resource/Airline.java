 ...
 * 
 */
public class Airline extends BaseResource {
	...
	public static String FIELD_AIRLINE_CODE = "airline_code";
	public static String FIELD_STATUS = "status";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("airline");
	...
	static {
		...
		airline_nameField.setIndexed(true);
		airline_nameField.setRequired(true);
		airline_nameField.setLength(128);
		metaData.addField(airline_nameField);

		Field airline_codeField = new Field("airline_code", "String");
		airline_codeField.setIndexed(true);
		airline_codeField.setRequired(true);
		airline_codeField.setLength(128);
		metaData.addField(airline_codeField);

		Field statusField = new Field("status", "String");
		statusField.setIndexed(true);
		...
		metaData.setTableName("airline");

		metaData.setCluster("DB_PROFILE");
	}

	public Airline() {this.setId(Util.getUniqueId());}
	public Airline(String id) {this.setId(id);}

	public Airline(Airline obj) {
		this.id = obj.id;
		...
		this.airline_code = obj.airline_code;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(airline_code != null)
			map.put("airline_code", airline_code);
		if(status != null)
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateAirline_name(add))
			map.put("airline_name", airline_name);
		if(validateAirline_code(add))
			map.put("airline_code", airline_code);
		if(status != null)
			map.put("status", status);
		if(extra_data != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		airline_code = (String) map.get("airline_code");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object airline_codeObj = map.get("airline_code");
		if(airline_codeObj != null)
			airline_code = airline_codeObj.toString();
	...
	public boolean validateAirline_name(boolean add) throws ApplicationException {
		if(add && airline_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[airline_name]");
		return airline_name != null;
	}
	...
	public String getAirline_codeEx() {
		return airline_code != null ? airline_code : "";
	}
	...
	public void unSetAirline_code() {
		this.airline_code = null;
	}

	public boolean validateAirline_code(boolean add) throws ApplicationException {
		if(add && airline_code == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[airline_code]");
		return airline_code != null;
	}
	...
	public  Class<?> getResultClass() {return AirlineResult.class;};
	public  Class<?> getMessageClass() {return AirlineMessage.class;};
	public  Class<?> getHelperClass() {return AirlineHelper.class;};
	public  Class<?> getServiceClass() {return AirlineService.class;};
}