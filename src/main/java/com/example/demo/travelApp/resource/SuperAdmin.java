 ...
 * 
 */
public class SuperAdmin extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("super_admin");
	...
	static {
		...
		metaData.setTableName("super_admin");

		metaData.setCluster("DB_PROFILE");
	}

	public SuperAdmin() {this.setId(Util.getUniqueId());}
	public SuperAdmin(String id) {this.setId(id);}

	public SuperAdmin(SuperAdmin obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return SuperAdminResult.class;};
	public  Class<?> getMessageClass() {return SuperAdminMessage.class;};
	public  Class<?> getHelperClass() {return SuperAdminHelper.class;};
	public  Class<?> getServiceClass() {return SuperAdminService.class;};
}