 ...
 * 
 */
public class AirlineAdmin extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("airline_admin");
	...
	static {
		...
		metaData.setTableName("airline_admin");

		metaData.setCluster("DB_PROFILE");
	}

	public AirlineAdmin() {this.setId(Util.getUniqueId());}
	public AirlineAdmin(String id) {this.setId(id);}

	public AirlineAdmin(AirlineAdmin obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return AirlineAdminResult.class;};
	public  Class<?> getMessageClass() {return AirlineAdminMessage.class;};
	public  Class<?> getHelperClass() {return AirlineAdminHelper.class;};
	public  Class<?> getServiceClass() {return AirlineAdminService.class;};
}